...
const Location = ({
  ...
  return (
    <motion.div
      ...
      className={`h-full flex flex-col justify-between gap-4 items-start bg-section backdrop-blur-2xl rounded-lg overflow-hidden group cursor-pointer relative ${className} not-md:w-full not-md:items-end`}
    >
